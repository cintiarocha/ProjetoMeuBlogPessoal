package com.generation.blogpessal.configuration;
		...
		public OpenAPI springBlogPessoalOpenAPI() {
	        ...
	        return new OpenAPI()
					...
					.contact(new Contact()
						...
						.url("https://github.com/cintiarocha/ProjetoMeuBlogPessoal")
						.email("cintia.rocha95@gmail.com")))
